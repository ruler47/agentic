...
export const queryKeys = {
  ...
  runWaits: (id: string) => ["runs", id, "tool-rework-waits"] as const,
  ...
  toolBuildRequests: ["tool-build-requests"] as const,
  toolInvestigations: ["tool-investigations"] as const,
  toolReworkWaits: ["tool-rework-waits"] as const,
